...
public class WheelView extends View {
	...
	private static final int VALUE_TEXT_COLOR = 0xff302b2a;
	...
	private void initResourcesIfNecessary() {
		...
		if(labelPaint==null){
			...
			labelPaint.setTextSize(textSize/2);
		}
		
		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(R.drawable.wheel_val_bk);
		}
	...
	private void drawValue(Canvas canvas) {
		...
		if (labelLayout != null) {
			canvas.save();
			canvas.translate(itemsLayout.getWidth() + LABEL_OFFSET, bounds.centerY());
